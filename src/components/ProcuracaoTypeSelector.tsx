...
export const ProcuracaoTypeSelector: React.FC<ProcuracaoTypeSelectorProps> = ({
  selectedType,
  onTypeSelect
}) => {
  const procuracaoTypes = [
    {
      type: 'pj' as ProcuracaoType,
      title: 'Pessoa Jurídica',
      description: 'Procuração para empresa/CNPJ',
      icon: <Building className="h-6 w-6" />
    },
    {
      type: 'pf' as ProcuracaoType,
      title: 'Pessoa Física',
      description: 'Procuração para pessoa física/CPF',
    ...
    <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-200 p-8 mb-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Selecione se a procuração é para pessoa física ou jurídica
        </p>
      </div>
